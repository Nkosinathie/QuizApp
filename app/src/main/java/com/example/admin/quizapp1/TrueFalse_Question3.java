...
public class TrueFalse_Question3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_true_false__question3);
    }
    ...
    {
        Intent intent = new Intent(TrueFalse_Question3.this,TrueFalse_Question2.class);
        startActivity(intent);
    }
    public void  next(View view)
    {
        Intent intent = new Intent(TrueFalse_Question3.this,TrueFalse_Question4.class);
    }
